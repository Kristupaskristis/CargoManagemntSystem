    ...
    function applyStyles() {
      ...
      if (!body.hasClass("rtl")) {
        ...
        if ($('.ps-enabled').length) {
          var psEnabled = new PerfectScrollbar('.ps-enabled');
        }
      }
    }
...
module.exports = __webpack_require__(/*! /var/www/html/bakalauras/resources/js/misc.js */"./resources/js/misc.js");
